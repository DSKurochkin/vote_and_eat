...
public class VoteTestData {
    ...
    public static final Vote vote1
            = new Vote(FIRST_VOTE_ID, getDate("2021-07-16"), getTime("09:00:00"), restaurant1, user1);
    public static final Vote vote2
            = new Vote(FIRST_VOTE_ID + 1, getDate("2021-07-16"), getTime("08:00:00"), restaurant2, user2);
