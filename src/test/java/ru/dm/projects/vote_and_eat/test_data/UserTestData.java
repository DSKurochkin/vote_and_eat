...
public class UserTestData {
    ...
    public static final User admin = new User(ADMIN_ID, "Admin", "admin1@vote.com", "admin1@vote.com", true );
    public static final User user1 = new User(FIRST_USER_ID, "User1","user1@vote.com" ,"user1@vote.com", false);
    public static final User user2 = new User(FIRST_USER_ID+1, "User2","user2@vote.com","user2@vote.com",false);

    public static List<User> restaurants= List.of(admin,user1,user2);

    public static User getNew(){
        return new User(null, "Testuser", "testuser@vote.com","testuser@vote.com",false);
    }
